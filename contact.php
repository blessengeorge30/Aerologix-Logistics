<?php
    ...
    if(isset($_POST["submit"]))
    {
     ...
     $user4 = $_POST["user_phoneno"];
     $user3 = $_POST["user_message"];

  
    date_default_timezone_set('Asia/Kolkata');
    $currentTime = date('d-m-Y H:i:s');
        $sql = "INSERT INTO enquires VALUES (NULL, '$user1', '$user2', '$user4','$user3', '$currentTime')";
                        ...
                        <div class="get-quote-form wow fadeInUp" data-wow-delay="0.75s">
                            ...
                            <form  action="" method="post" data-toggle="validator">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12 mb-3">
                                        <textarea name="user_message" class="form-control" id="msg" rows="3" placeholder="Write Your Message" required></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
