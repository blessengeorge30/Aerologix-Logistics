<?php
    ...
    if(isset($_POST["submission"]))
    {
     ...
     $user2 = $_POST["i2"];
        ...
        $sql = "INSERT INTO tracking_air VALUES (NULL, '$u1', '$user2')";
    ...
    {
        $T_id= $_POST["deletion"];
        $sql = "DELETE from tracking_air WHERE T_ID = '$T_id'";
        if (mysqli_query($conn, $sql)) 
        {
            function submitForm() 
            {
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Air </strong> tracking </h2>
