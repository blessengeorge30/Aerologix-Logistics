...
<body class="tt-magic-cursor">
 ...
 <?php include "import/header.php"; ?>
                ...
                <div class="col-lg-6 col-md-7">
                    ...
                    <div class="hero-content">
                        <div class="hero-content-title">
                            <h1 class="text-anime-style-3">Sinai Logistics Private Limited  <span>around the world</span></h1>
                        </div>
                        <div class="hero-content-body wow fadeInUp"  data-wow-delay="0.25s">
                            <p> At Sinai Logistics Private Limited, we are dedicated to transforming the logistics landscape with our unparalleled expertise and commitment to excellence since 2008.</p>
                        </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="cargo-shipment-item wow fadeInUp"  data-wow-delay="0.25s">
                        ...
                        <div class="cargo-shipment-content">
                            ...
                            <h3>Ocean Freight</h3>
                            <p>For large-scale shipments and cost-effective international transport, our ocean freight services are the ideal solution</p>
                ...
                <div class="col-md-4">
                    ...
                    <div class="cargo-shipment-item active wow fadeInUp"  data-wow-delay="0.5s">
                        ...
                        <div class="cargo-shipment-content">
                            ...
                            <h3>Air Freight</h3>
                            <p>Ensures your time-sensitive shipments reach their destination quickly and safely</p>
                            <div class="cargo-shipment-readmore">
                                <a href="#">Read More</a>
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="cargo-shipment-item wow fadeInUp"  data-wow-delay="0.75s">
                        ...
                        <div class="cargo-shipment-content">
                            ...
                            <p>Our experienced customs brokers works diligently to minimize delays and ensure your goods clear customs efficiently.</p>
                            <div class="cargo-shipment-readmore">
                                <a href="#">Read More</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 col-md-12 order-lg-1 order-md-2 order-2">
                    ...
                    <div class="home-transportation-content">
                        ...
                        <div class="home-transportation-body">
                            <p class="wow fadeInUp" data-wow-delay="0.25s">Navigating the complexities of global shipping can be daunting. At Sinai Logistics, we make it simple. Our international freight forwarding services encompass air, sea, and land transportation </p>
                            <p class="wow fadeInUp" data-wow-delay="0.5s">providing you with comprehensive solutions tailored to meet your unique needs. With a network of trusted partners worldwide, we ensure your shipments are handled with care and precision.</p>
                        </div>
    ...
    <div class="our-service">
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="our-service-item wow fadeInUp" data-wow-delay="0.25s">
                        ...
                        <div class="our-service-content">
                            ...
                            <div class="our-service-content-button">
                                <a href="service-details.html"><i class="fa-regular fa-circle-right"></i></a>
                            </div>                         
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <!-- Our Service Item Start -->
                    <div class="our-service-item wow fadeInUp" data-wow-delay="1s">
                        <!-- Our Service Image Start -->
                        <div class="our-service-image">
                            <figure class="image-anime">
                ...
                <div class="col-lg-4 col-md-6">
                    <!-- Our Service Item Start -->
                    <div class="our-service-item wow fadeInUp" data-wow-delay="1.25s">
                        <!-- Our Service Image Start -->
                        <div class="our-service-image">
                            <figure class="image-anime">
                ...
                <div class="col-lg-4 col-md-6">
                    <!-- Our Service Item Start -->
                    <div class="our-service-item wow fadeInUp" data-wow-delay="1.5s">
                        <!-- Our Service Image Start -->
                        <div class="our-service-image">
                            <figure class="image-anime">
    ...
    <div class="recent-project">
        <div class="container">
            <div class="row">
                <!-- Section Title Start -->
                <div class="section-title">
                    <h2 class="text-anime-style-3">Explore <span> our Expertise</span></h2>
                    <p class="wow fadeInUp" data-wow-delay="0.25s">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                </div>
                <!-- Section Title End -->
            </div>
    ...
    <!-- <div class="providing-service" style="margin-bottom: 80px;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="section-title">
                    ...
                    <p class="wow fadeInUp" data-wow-delay="0.25s">Stay informed with the latest news and articles on cargo transportation and industry trends</p>
                </div>
